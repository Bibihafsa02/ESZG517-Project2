...
BROKER_URL  = "c9b9df6e51b240ca8a21a5dbe50d227a.s1.eu.hivemq.cloud"     # Your HiveMQ cluster URL
BROKER_PORT = 8883                                # TODO-4  # 8883: secure MQTT port (TLS)
USERNAME    = "2025ca01070"                           # Your HiveMQ username
PASSWORD    = "Hafsa@2001"                        # Your HiveMQ password
YOUR_USN    = "2025ca01070"                             # e.g. "2023HT12345"
...
def publish_smoke(client, smoke_ppm):
    # TODO-A1: Publish smoke_ppm to TOPIC_SMOKE
    pass

def publish_co(client, co_ppm):
    # TODO-A2: Publish co_ppm to TOPIC_CO
    pass

def publish_door(client, door_open):
    # TODO-A3: Publish door_open to TOPIC_DOOR
    pass

def publish_window(client, window_open):
    # TODO-A4: Publish window_open to TOPIC_WINDOW
    pass

def publish_sound(client, sound_db):
    # TODO-A5: Publish sound_db to TOPIC_SOUND
    pass

def publish_indoor_temp(client, indoor_temp):
    # TODO-A6: Publish indoor_temp to TOPIC_INDOOR_TEMP
    pass

def publish_indoor_humidity(client, indoor_humidity):
    # TODO-A7: Publish indoor_humidity to TOPIC_INDOOR_HUM
    pass
